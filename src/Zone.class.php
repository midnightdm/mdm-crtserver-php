...
class ZONE {
    ...
    public static $mjoyce_slough_clinton = ["at Joyce Slough in Clinton", "at Joyce Slough, home of Clinton Marina"];
    ...
    public static $m532 = ["at mile 532, 9.5 abv Lock 13, 3 blw Sabula drawbridge","at mile 532, 9.5 miles above Lock 13 and 3 miles below the sub Bula drawbridge"];
    public static $m533 = ["at mile 533, 10.5 abv Lock 13, 2 blw Sabula drawbridge","at mile 533, 10.5 miles above Lock 13 and 2 miles below the sub Bula drawbridge"];
    public static $m534 = ["at marker 534 1 mile below Sabula drawbridge","at marker 534, 1 mile below the sub Bula drawbridge"];
    public static $msabula = ["In Island City Harbor at Sabula", "in Island City Harbor at sub Bula"];
    public static $m535 = ["at marker 535 Sabula drawbridge","at marker 535, the sub Bula drawbridge"];
    public static $m536 = ["at marker 536 1 mile above Sabula drawbridge","at marker 536, 1 mile above the sub Bula drawbridge"];
    public static $m537 = ["at Savanna, IL 2 miles above Sabula drawbridge","at Savanna Illinois, 2 miles above the sub Bula drawbridge"];
    public static $m538 = ["at marker 538 3 miles above Sabula drawbridge","at marker 538, 3 miles above the sub Bula drawbridge"];
    ...
    public static $m540 = ["at marker 540 5 miles above Sabula drawbridge","at marker 540, 5 miles above the sub Bula drawbridge"];
    ...
    public static $m542 = ["at marker 542 7 miles above Sabula drawbridge","at marker 542, 7 miles above the sub Bula drawbridge"];
    public static $m543 = ["at marker 543 by Palisades Golf Course","at marker 543 by Palisades Golf Course"];
    public static $m544 = ["at marker 544, 1 mile below Ka-Ching Global Sourcing","at marker 544, 1 miles below Ka-Ching Global Sourcing"];
    public static $m545 = ["at marker 545 by Ka-Ching Global Sourcing","at marker 545 by Ka-Ching Global Sourcing"];
    public static $m546 = ["at marker 546 by TLC Rail Services","at marker 546 by TLC Rail Services"];
    public static $m547 = ["at marker 547 by Green Island, Iowa","at marker 547 by Green Island, Iowa"];
    public static $m548 = ["at marker 548 by the mouth of the Maquoketa River","at marker 548 by the mouth of the Maquoketa River"];
    public static $m549 = ["at marker 549, a half mile above the Maquoketa River","at marker 549 a half mile above the Maquoketa River"];
    public static $m550 = ["at marker 550, 6 miles below Bellevue","at marker 550, 6 miles below Bellevue"];
    public static $m551 = ["at marker 551, 5 miles below Bellevue","at marker 551, 5 miles below Bellevue"];
    public static $m552 = ["at marker 552, 4 miles below Bellevue","at marker 552, 4 miles below Bellevue"];
    public static $m553 = ["at marker 553, 3 miles below Bellevue","at marker 553, 3 miles below Bellevue"];
    public static $m554 = ["at marker 554, 2miles below Bellevue","at marker 554, 2 miles below Bellevue"];
    public static $m555 = ["at marker 555, 1 mile below Bellevue","at marker 555, 1 mile below Bellevue"];
    public static $m556 = ["at marker 556 just below lock 12 in Bellevue","at marker 556 just below lock 12 in Bellevue"];
    public static $m557 = ["at marker 557 just above lock 12 in Bellevue","at marker 557 just above lock 12 in Bellevue"];
    public static $m558 = ["at marker 558, 1 mile above lock 12","at marker 558, 1 mile above lock 12"];
    public static $m559 = ["at marker 559, 2 miles above lock 12","at marker 559, 2 miles above lock 12"];
    public static $m560 =  ["at marker 560, 3 miles above lock 12","at marker 560, 3 miles above lock 12"];
    public static $m561 =  ["at marker 561, 4 miles above lock 12","at marker 561, 4 miles above lock 12"];
    public static $m562 =  ["at marker 562, 5 miles above lock 12","at marker 562, 5 miles above lock 12"];
    public static $m563 =  ["at marker 563, 6 miles above lock 12","at marker 563, 6 miles above lock 12"];
    public static $m564 =  ["at marker 564, 7 miles above lock 12","at marker 564, 7 miles above lock 12"];
    public static $m565 =  ["at marker 565, 8 miles above lock 12","at marker 565, 8 miles above lock 12"];
    public static $m566 =  ["at marker 566, 9 miles above lock 12","at marker 566, 9 miles above lock 12"];
    public static $m567 =  ["at marker 567, 10 miles above lock 12","at marker 567, 10 miles above lock 12"];
    public static $m568 =  ["at marker 568, 11 miles above lock 12","at marker 568, 11 miles above lock 12"];
    public static $m569 =  ["at marker 569, 12 miles above lock 12","at marker 569, 12 miles above lock 12"];
