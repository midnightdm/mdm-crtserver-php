...
class ZONE {
   ...
   public static $m464 =["at M-464 by Shady Creek Rec Area", "at marker 464 by Shady Creek Recreation Area", 464];
    ...
    public static $m569 =  ["at marker 569, 10 miles below US 61 bridge","at marker 569, 10 miles below the US 61 bridge", 569];

    public static $m570 = ["at marker 570, 9 miles below US 61 bridge","at marker 570, 9 miles below the US 61 bridge", 570];
    public static $m571 = ["at marker 571, 8 miles below US 61 bridge","at marker 571, 8 miles below the US 61 bridge", 571];
    public static $m572 = ["at marker 572, 7 miles below US 61 bridge","at marker 572, 7 miles below the US 61 bridge", 572];
    public static $m573 = ["at marker 573, 6 miles below US 61 bridge","at marker 573, 6 miles below the US 61 bridge", 573];
    public static $m574 = ["at marker 574, 5 miles below US 61 bridge","at marker 574, 5 miles below the US 61 bridge", 574];
    public static $m575 = ["at marker 575, 4 miles below US 61 bridge","at marker 575, 4 miles below the US 61 bridge", 575];
    public static $m576 = ["at marker 576, 3 miles below US 61 bridge","at marker 576, 3 miles below the US 61 bridge", 576];
    public static $m577 = ["at marker 577, 2 miles below US 61 bridge","at marker 577, 2 miles below the US 61 bridge", 577];
    public static $m578 = ["at marker 578, 1 mile below US 61 bridge","at marker 578, 1 mile below the US 61 bridge", 578];
    public static $m579 = ["at marker 579, by US 61 bridge","at marker 579, by the US 61 bridge", 579];
    public static $m580 = ["at marker 580, Dubuque RR Drawbridge","at marker 580, the Dubuque railroad drawbridge", 580];
    public static $m581 = ["at marker 581, downtown Dubuque, IA","at marker 581, downtown Dubuque, Iowa", 581];
    public static $m582 = ["at marker 582, 1 mile below Lock 11","at marker 582, 1 mile below Lock 11", 582];
    public static $m583 = ["at marker 583, just above Lock 11","at marker 583, just above Lock 11 in Dubuque", 583];
    public static $m584 = ["at marker 584, 1 mile above Lock 11","at marker 584, 1 mile above Lock 11", 584];
    public static $m585 = ["at marker 585, 2 miles above Lock 11","at marker 585, 2 miles above Lock 11", 585];
    public static $m586 = ["at marker 586, 3 miles above Lock 11","at marker 586, 3 miles above Lock 11", 586];
    public static $m587 = ["at marker 587, 4 miles above Lock 11","at marker 587, 4 miles above Lock 11", 587];
    public static $m588 = ["at marker 588, near Dickeyville, WI","at marker 588, near Dickeyville, Wisconsin", 588];
    public static $m589 = ["at marker 589, by Mud Lake Park","at marker 589, by Mud Lake Park", 589];
    public static $m590 = ["at marker 590, by Grant River Rec Area","at marker 590, by Grant River Recreation Area", 590];
    public static $m591 = ["at marker 591, 8 miles above Lock 11","at marker 591, 8 miles above Lock 11", 591];
    public static $m592 = ["at marker 592, by Potosi Point Rec Area","at marker 592, by Potosi Point Recreation Area", 592];
    public static $m593 = ["at marker 593, 10 miles above Lock 11","at marker 593, 10 miles above Lock 11", 593];
    public static $m594 = ["at marker 594, 11 miles above Lock 11","at marker 594, 11 miles above Lock 11", 594];
    public static $m595 = ["at marker 595, 12 miles above Lock 11","at marker 595, 12 miles above Lock 11", 595];
    public static $m596 = ["at marker 596, Finley's Landing Park", "at marker 596, by Finley's Landing Park", 596];
    public static $m597 = ["at marker 597, 3 miles below Waupeton, IA","at marker 597, 3 miles below Waupeton, Iowa", 597];
    public static $m598 = ["at marker 598, 2 miles below Waupeton, IA","at marker 598, 2 miles below Waupeton, Iowa", 598];
    public static $m599 = ["at marker 599, 1 mile below Waupeton, IA","at marker 599, 1 mile below Waupeton, Iowa", 599];
    public static $m600 = ["at marker 600, by Waupeton, IA","at marker 600, by Waupeton, Iowa", 600];
    public static $m601 = ["at marker 601, 1 mile above Waupeton, IA","at marker 601, 1 mile above Waupeton, Iowa", 601];
    public static $m602 = ["at marker 602, 2 miles above Waupeton, IA","at marker 602, 2 miles above Waupeton, Iowa", 602];
    public static $m603 = ["at marker 603 by N Buena Vista, IA","at marker 603 by North Buena Vista, Iowa", 603];
    public static $m604 = ["at marker 604, 2 miles below Cassville, WI","at marker 604, 2 miles below Cassville, Wisconsin", 604];
    public static $m605 = ["at marker 605, 1 mile below Cassville, WI","at marker 605, 1 mile below Cassville, Wisconsin", 605];
    public static $m606 = ["at marker 606 by Cassville, WI","at marker 606 by Cassville, Wisconsin", 606];
    public static $m607 = ["at marker 607, 1 mile above Cassville, WI","at marker 607, 1 mile above Cassville, Wisconsin", 607];
    public static $m608 = ["at marker 608, conjunction of Turkey River","at marker 608, at the conjunction of the Turkey River", 608];
    public static $m609 = ["at marker 609, by Turkey River Mounds","at marker 609, by the Turkey River Mounds State Monument", 609];
    public static $m610 = ["at marker 610, 5 miles below Lock 10", "at marker 610, 5 miles below Lock 10", 610];
    public static $m611 = ["at marker 611, 4 miles below Lock 10", "at marker 611, 4 miles below Lock 10", 611];
    public static $m612 = ["at marker 612, 3 miles below Lock 10", "at marker 612, 3 miles below Lock 10", 612];
    public static $m613 = ["at marker 613, 2 miles below Lock 10", "at marker 613, 2 miles below Lock 10", 613];
    public static $m614 = ["at marker 614, Guttenberg, IA", "at marker 614, Guttenberg, Iowa", 614];
    public static $m615 = ["at marker 615, Lock 10 Guttenberg", "at marker 615, Lock and Dam 10 at Guttenberg, Iowa", 615];
    public static $m616 = ["at marker 616, 1 mile above Lock 10", "at marker 616, 1 mile above Lock 10", 616];
    public static $m617 = ["at marker 617, 2 miles above Lock 10", "at marker 617, 2 miles above Lock 10", 617];
    public static $m618 = ["at marker 618, 3 miles above Lock 10", "at marker 618, 3 miles above Lock 10", 618];
    public static $m619 = ["at marker 619, 4 miles above Lock 10", "at marker 619, 4 miles above Lock 10", 619];
    public static $m620 = ["at marker 620, 5 miles above Lock 10", "at marker 620, 5 miles above Lock 10", 620];
    public static $m621 = ["at marker 621, 2 miles below Bagley, WI", "at marker 621, 2 miles below Bagley, Wisconsin", 621];
    public static $m622 = ["at marker 622, 1 mile below Bagley, WI", "at marker 622, 1 mile below Bagley, Wisconsin", 622];
    public static $m623 = ["at marker 623, by Bagley, WI", "at marker 623, by Bagley, Wisconsin", 623];
    public static $m624 = ["at marker 624, by Clayton, IA", "at marker 624, by Clayton, Iowa", 624];
    public static $m625 = ["at marker 625, just above Clayton, IA", "at marker 625, just above Clayton, Iowa", 625];
    public static $m626 = ["at marker 626, 1 mile below Wyalusing, WI", "at marker 626, 1 mile below Wyalusing, Wisconsin", 626];
    public static $m627 = ["at marker 627, by Wyalusing, WI", "at marker 627, by Wyalusing, Wisconsin", 627];
    public static $m628 = ["at marker 628, 1 mile above Wyalusing, WI", "at marker 628, 1 mile above Wyalusing, Wisconsin", 628];
    public static $m629 = ["at marker 629, by Wyalusing State Park", "at marker 629, by Wyalusing State Park", 629];
    public static $m630 = ["at marker 630, 3 mi below Prarie duChien, WI", "at marker 630, 3 miles below Prairie du Chien, Wisconsin", 630];
    public static $m631 = ["at marker 631, 2 mi below Prarie duChien, WI", "at marker 631, 2 miles below Prairie du Chien, Wisconsin", 631];
